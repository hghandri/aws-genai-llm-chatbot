...
export class DeleteDocument extends Construct {
  ...
  constructor(scope: Construct, id: string, props: DeleteDocumentProps) {
      ...
      "DeleteDocumentFunction",
      {
        ...
        environment: {
          ...
          WORKSPACES_POLICY_TABLE_NAME:
            props.ragDynamoDBTables.workspacesPolicyTable.tableName,
          WORKSPACES_BY_OBJECT_TYPE_INDEX_NAME:
            props.ragDynamoDBTables.workspacesByObjectTypeIndexName,
          WORKSPACES_POLICY_BY_WORKSPACE_ID_INDEX_NAME:
            props.ragDynamoDBTables.workspacesPolicyByWorkspaceIdIndexName,
    ...
    props.ragDynamoDBTables.workspacesPolicyTable.grantReadWriteData(deleteFunction);
